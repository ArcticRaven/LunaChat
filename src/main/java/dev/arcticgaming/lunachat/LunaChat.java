package dev.arcticgaming.lunachat;

import dev.arcticgaming.lunachat.ChatOperators.DirectMessages;
import dev.arcticgaming.lunachat.EventHandlers.ChatEvent;
...
public final class LunaChat extends JavaPlugin implements @NotNull Listener {

    private BukkitAudiences adventure;

    public static LunaChat plugin;
    public static LunaChat getPlugin() {
        return plugin;
    }
